...
from app.external.db.models import Base  # noqa
...
def get_url():
    env_prefix = 'CC_POSTGRES__'
    user = os.getenv(f"{env_prefix}USER", "admin")
    ...
    db = os.getenv(f"{env_prefix}DB_NAME", "credit_card")
